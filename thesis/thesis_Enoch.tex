...
\ifpdf  
    \pdfinfo { /Title  (Development of an Efficient Public Transport Search Portal for Ghana)
               /Creator (TeX)
               /Producer (pdfTeX)
               /Author (Enock Seth Nyamador enockseth@gmail.com)
               /CreationDate (D:YYYYMMDDhhmmss)  %format D:YYYYMMDDhhmmss
               /ModDate (D:YYYYMMDDhhmm)
               /Subject (xyz)
               /Keywords (transport, ghana, station) }
...
\renewcommand\listfigurename{\centerline{\bfseries\large LIST OF FIGURES}\global\def\listfigurename{LIST OF FIGURES}}
%\renewcommand{\listfigurename}{\hfill\bfseries\large LIST OF FIGURES \hfil}   
...
\include{2/Chapter2}						% aims of the project
\include{3/Chapter3}						% system design and analysis
\include{4/Chapter4}
\include{5/Chapter5}
...
%\renewcommand{\bibname}{\centerline{\textbf{REFERENCES}}} % changes the header; default: Bibliography
\renewcommand\bibname{\centerline{\bfseries\large REFERENCES}\global\def\bibname{REFERENCES}}
\renewcommand{\vspace}[2]{}
...
\lstinputlisting[language=Python]{/home/kakarot/terminalfinder/terminal/mm.py}
\end{document}
